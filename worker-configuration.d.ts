/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5f7640445861b68088971c3319a59ba8)
// Runtime types generated with workerd@1.20260507.1 2026-05-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "APICache";
	}
	interface Env {
		...
		STEAM_ID: string;
		XBL_API_KEY: string;
		API_CACHE: DurableObjectNamespace<import("./src/index").APICache>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "SPOTIFY_REFRESH_TOKEN" | "STEAM_API_KEY" | "STEAM_ID" | "XBL_API_KEY">> {}
}
